...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, dim, num_heads, window_size=(7,7), shift_size=(0,0),
        ...
        assert 0 <= self.shift_size[0] < self.window_size[0], "shift_size h must in 0-window_size"
        assert 0 <= self.shift_size[1] < self.window_size[1], "shift_size w must in 0-window_size"
